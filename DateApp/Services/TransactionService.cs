...
namespace DateApp.Services
{
    public class TransactionService : ITransactionService
    {
        ...
        public TransactionService(IMediator mediator, IPaypalRepository paypalRepository, IUserService userService)
        {
        ...
        public async Task<string> ConfirmTransaction(string? payerID, string? guid, string? username)
        {
            ...
            var checkUserVipStatusByName = new CheckUserVipStatusByNameQuery
            {
                UserName = username
            };

            var vipUser = await _mediator.Send(checkUserVipStatusByName);
